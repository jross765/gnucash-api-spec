										     ...
										     implements GnuCashStockBuyTransaction
{
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(GnuCashStockBuyTransactionImpl.class);
	...
	public GnuCashStockBuyTransactionImpl(GnuCashTransactionImpl trx) {
		super(trx);
	...
	private void validateTaxesFeesAcctSplit(final GnuCashTransactionSplit splt) throws TransactionValidationException {
		...
		if ( ! splt.getQuantity().equals( splt.getValue() ) ) {
			String msg = "the split's quantity is not equal to ist value";
			LOGGER.error("validateTaxesFeesAcctSplit: " + msg);
			throw new TransactionValidationException(msg);
		}
	}
	...
	public String toString() {
		...
		buffer.append("GnuCashStockBuyTransactionImpl [");
